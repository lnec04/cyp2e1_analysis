...
| `04_accessibility_profiling.R`          | Quantifies baseline ATAC accessibility (prevalence and magnitude) of P1–P8 across all cell types                                           | `export/04_peak_accessibility_by_celltype.csv`                                                                                                       |
| `05_motif_analysis.R`                   | Maps JASPAR2020 Homo sapiens motifs to P1–P8 elements; constructs binary occupancy matrix; Fisher's exact test for driver TF motif enrichment in P1–P8 vs. Normal hepatocyte background | `export/05_motif_occupancy_matrix_p1_p8.csv`<br>`export/05_motif_enrichment_fisher.csv`                                                             |
